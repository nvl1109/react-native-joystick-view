...
public class JoystickViewModule extends ReactContextBaseJavaModule {
  // Constants
  private static final String RAD_KEY = "RAD";
  private static final String DEFAULT_LOOP_INTERVAL_KEY = "DEFAULT_LOOP_INTERVAL";
  private static final String FRONT_KEY = "FRONT";
  private static final String FRONT_RIGHT_KEY = "FRONT_RIGHT";
  private static final String RIGHT_KEY = "RIGHT";
  private static final String RIGHT_BOTTOM_KEY = "RIGHT_BOTTOM";
  private static final String BOTTOM_KEY = "BOTTOM";
  private static final String BOTTOM_LEFT_KEY = "BOTTOM_LEFT";
  private static final String LEFT_KEY = "LEFT";
  private static final String LEFT_FRONT_KEY = "LEFT_FRONT";
  ...
  public JoystickViewModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
  ...
  public Map<String, Object> getConstants() {
    ...
    constants.put(RAD_KEY, 57.2957795);
    constants.put(DEFAULT_LOOP_INTERVAL_KEY, 100);
    constants.put(FRONT_KEY, 3);
    constants.put(FRONT_RIGHT_KEY, 4);
    constants.put(RIGHT_KEY, 5);
    constants.put(RIGHT_BOTTOM_KEY, 6);
    constants.put(BOTTOM_KEY, 7);
    constants.put(BOTTOM_LEFT_KEY, 8);
    constants.put(LEFT_KEY, 1);
    constants.put(LEFT_FRONT_KEY, 2);
    return constants;
  }
  ...
  @ReactMethod
  public void showJoyStick(String message, int duration) {
